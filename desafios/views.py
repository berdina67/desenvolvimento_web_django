...
def desafio_semana(request, dia):
    try:
        desafio = desafios_dia_semana[dia] # ***** Parte original do código ***** 
        return render(request, "desafios/desafio.html", {
            'desafio':desafio,
            'dia':dia
        })
    except:
        # return HttpResponseNotFound("Para esse parâmetro não há desafio") **** Linha substituída ****
        return render(request, "404.html")
    
    # return HttpResponse(desafio) **** Linha substituída ****